...
userRouter.post("/", validation_1.default.isValidUser, userController_1.default.createUser);
...
userRouter.patch("/:id", validation_1.default.isValidUser, userController_1.default.updateUserById);
