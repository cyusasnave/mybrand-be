...
blogRouter.patch("/:id", authentication_1.default.authLogIn, blogsController_1.default.updateBlog);
blogRouter.delete("/:id", authentication_1.default.authLogIn, blogsController_1.default.deleteBlog);
